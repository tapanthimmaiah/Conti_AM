...
public class ExcelUtility {
	...
	public HashMap<String, String>  readMappingFile(String attributeMappingFileName)
	{
		HashMap<String, String> mergeAttributesMap= new HashMap<>();
		String columOne,columnTwo= null;
		DataFormatter df = new DataFormatter();
		int c = 0;
		try
		{
			...
			while (iterator.hasNext()) {
				...
				if (c == 0) {
					...
					mergeAttributesMap.put(columOne, columnTwo);
				}
			}
			return mergeAttributesMap;
